...
public class CursoService {
	...
	public boolean ingresarCursoResponse(Curso curso) {
		responseServer = false;
		...
		//TODO: Verificar con Leo como recepciona el JsonArray
		Call<Boolean> respuesta = interfaz.ingresarCurso("Bearer " + Token.getInstance().getToken(), jo ,curso.getNombreAsignatura());
