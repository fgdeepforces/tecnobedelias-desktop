...
//	}
	...
	public Curso_Estudiante(Integer id, String estado, Integer nota, String nombre, String apellido, String cedula,
	...
	public String toString() {
		return "Curso_Estudiante [id=" + id + ", estado=" + estado + ", nota=" + nota + ", nombre=" + nombre
				+ ", apellido=" + apellido + ", cedula=" + cedula + ", id_curso=" + id_curso + ", id_estudiante="
				+ id_estudiante + "]";
	}
